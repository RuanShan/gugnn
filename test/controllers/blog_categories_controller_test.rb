...
class BlogCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_category" do
    assert_difference('BlogCategory.count') do
      post blog_categories_url, params: { blog_category: { ctype: @blog_category.ctype, description: @blog_category.description, title: @blog_category.title } }
    end
  ...
  test "should update blog_category" do
    patch blog_category_url(@blog_category), params: { blog_category: { ctype: @blog_category.ctype, description: @blog_category.description, title: @blog_category.title } }
